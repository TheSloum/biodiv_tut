    ...
    public class E_EventSettings : ScriptableObject
    {
        ...
        [Header("Animation par défaut (aucun événement)")]
        public AnimationClip defaultMapAnimation;
    }
    ...
    public class InvasionType
    {
        ...
        [Tooltip("Animation de la map pour cette invasion")]
        public AnimationClip mapAnimation;
    }
    ...
    public class NormalEventType
    {
        ...
        [Tooltip("Animation de la map pour cet événement")]
        public AnimationClip mapAnimation;
    }